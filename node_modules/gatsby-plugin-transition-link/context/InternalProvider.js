...
function (_Component) {
  ...
  function InternalProvider(props) {
    ...
    var prefersReducedMotionSetting = typeof window !== "undefined" && window.matchMedia('(prefers-reduced-motion: reduce)');
    var prefersReducedMotion = prefersReducedMotionSetting;
